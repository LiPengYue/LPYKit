...
@implementation BaseButtonHandler
+ (BaseButtonHandler *(^)(UIButton *button)) handle {
    return ^(UIButton *button) {
        BaseButtonHandler *handler = [BaseButtonHandler new];
        handler.button = button;
        return handler;
    };
}

- (BaseButtonHandler *(^)(UIFont *)) setUpFont {
...
- (BaseButtonHandler *(^)(CGFloat)) setUpCornerRadius {
    __weak typeof (self) weakSelf = self;
...
- (void)setUpStyle:(NSInteger) state style:(void(^)(BaseButtonHandler *handler))callBack {
    self.state = state;
...
- (BaseButtonHandler *(^)(UIColor *)) setUpTitleColor {
    __weak typeof (self)weakSelf = self;
...
- (BaseButtonHandler *(^)(UIColor *)) setUpBackgroundColor {
    __weak typeof (self)weakSelf = self;
    return ^(UIColor *color) {
...
- (BaseButtonHandler *(^)(NSString *)) setUpTitle {
    __weak typeof (self)weakSelf = self;
...
- (BaseButtonHandler *(^)(NSAttributedString *)) setUpAttributedString {
    __weak typeof (self)weakSelf = self;
...
- (BaseButtonHandler *(^)(UIImage *))setUpImage {
    __weak typeof (self)weakSelf = self;
...
- (BaseButtonHandler *(^)(NSString *name)) setUpImageName {
    __weak typeof (self)weakSelf = self;
...
- (BaseButtonHandler *(^)(UIImage *))setUpBackgroundImage {
    __weak typeof (self)weakSelf = self;
    return ^(UIImage *image) {
...
- (BaseButtonHandler *(^)(NSString *)) setUpBackgroundImageName {
    __weak typeof (self)weakSelf = self;
...
- (BaseButtonHandler *(^)(CGFloat)) setUpBorderWidth {
    __weak typeof (self)weakSelf = self;
...
- (BaseButtonHandler *(^)(UIColor *)) setUpBorderColor {
    __weak typeof (self)weakSelf = self;
    return ^(UIColor *color) {
        if (!self.py_isTagState || weakSelf.state == weakSelf.state) {
...
//- (BaseButtonHandler *(^)(CGFloat,CGFloat,CGFloat,CGFloat)) setUpTitleEdgeInsets {
//    __weak typeof (self)weakSelf = self;
...
//    };
//}
//- (BaseButtonHandler *(^)(CGFloat,CGFloat,CGFloat,CGFloat)) setUpImageEdgeInsets;
