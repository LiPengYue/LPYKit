...
@interface ViewShadowConfigration ()
...
@implementation ViewShadowConfigration

+ (ViewShadowConfigration *(^)(CALayer *layer)) create {
    return ^(CALayer *layer) {
         ViewShadowConfigration *handler = [ViewShadowConfigration new];
        handler.layer = layer;
        return handler;
    };
}
