...
@property (nonatomic,strong) BaseGradientViewDrawRadialConfig *drawRadialConfig;
@property (nonatomic,strong) BaseGradientViewLineConfig *drawLineConfig;
...
- (void) drawLineGradientWithContext: (CGContextRef)context {
    ...
    BaseGradientViewLineConfig *config = self.drawLineConfig;
...
-(void)drawRadialGradientWithContext:(CGContextRef)context{
     ...
     */
    BaseGradientViewDrawRadialConfig *config = self.drawRadialConfig;
    CGPoint startCenter = [self getCenterWithCenter:config.startCenter andScaleCenter:config.startScaleCenter];
    CGPoint endCenter = [self getCenterWithCenter:config.endCenter andScaleCenter:config.endScaleCenter];
...
- (BaseGradientViewDrawRadialConfig *)drawRadialConfig {
    if (!_drawRadialConfig) {
        _drawRadialConfig = [BaseGradientViewDrawRadialConfig new];
    }
    return _drawRadialConfig;
}
- (BaseGradientViewLineConfig *)drawLineConfig {
    if (!_drawLineConfig) {
        _drawLineConfig = [BaseGradientViewLineConfig new];
    }
